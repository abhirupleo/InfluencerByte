...
data = data = pd.read_excel('twitter_cleaned.xlsx', sheet_name='TV')
...
def go_click():
    ...
    twitterResultDataframe = data[data['FullTweetText'].str.contains('tv' or 'telivision')]
