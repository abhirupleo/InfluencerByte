...
data = data = pd.read_excel('twitter_cleaned.xlsx', sheet_name='Smart Watch')
...
def go_click():
    ...
    twitterResultDataframe = data[data['FullTweetText'].str.contains('smart watch' or 'watch')]
