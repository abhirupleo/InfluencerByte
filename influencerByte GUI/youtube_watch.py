...
data = data = pd.read_excel('youtube_cleaned.xlsx', sheet_name='Watch')
...
def help_info_click():
    messagebox.showinfo("INFO", "Produced by Jenny Niemann, Abihrup, Cavya, Darshil")
def go_click():
    global dynamic
    global count
    global data
