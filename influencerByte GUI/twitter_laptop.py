...
data = data = pd.read_excel('twitter_cleaned.xlsx', sheet_name='Laptop')
...
def go_click():
    ...
    twitterResultDataframe = data[data['FullTweetText'].str.contains('Laptop' or 'Technology')]
