...
GUI for the podcast platform advertising for a telivision
"""
...
data = data = pd.read_excel('patreon_cleaned.xls', sheet_name='TV')
...
def go_click():
    print("\nRecommending you an influencer to market your tv...\n")
    global dynamic
    global count
    global data
...
#Tkinter Code
window = Tk()
window.title("POADCAST - TELIVISION")
window.geometry('500x200')
header = Label(window, text="Telivision", font=("Britannic Bold", 18))
